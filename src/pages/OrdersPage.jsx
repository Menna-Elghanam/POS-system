...
const OrdersPage = () => {
  ...
  // State for order type (place or delivery)
  const [orderType, setOrderType] = useState("place");
  // State for selected table number (only if orderType is "place")
  const [selectedTable, setSelectedTable] = useState("");
  // State for delivery address (only if orderType is "delivery")
  const [deliveryAddress, setDeliveryAddress] = useState("");

  const handleOrderTypeChange = (e) => {
    setOrderType(e.target.value);
    // Reset table number or delivery address when the order type changes
    setSelectedTable("");
    setDeliveryAddress("");
  };
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      ...
      {/* Table Selection (only if orderType is "place") */}
      {orderType === "place" && (
        <div className="mb-6">
          ...
          >
            ...
            {["Table 1", "Table 2", "Table 3", "Table 4","Table 5", "Table 6", "Table 7", "Table 8"].map((table, index) => (
      ...
      {/* Delivery Address (only if orderType is "delivery") */}
      {orderType === "delivery" && (
        <div className="mb-6">
